...
static int8_t MenuQuitter(char* key, ti_var_t* sauvegarde, EmpireListe* empireListe, Empire* joueur, Parametres* parametres, Date* date, SystemeStellaire* systemeStellaires, Camera* camera, Marche* marche, Fenetre* fenetre);

static void MenuSysteme(char* key, EmpireListe* empireListe, Empire* joueur, Parametres* parametres, Date* date, SystemeStellaire* systemeStellaires, Camera* camera, Marche* marche, Fenetre* fenetre);
static void MenuSystemeFlotte(char* key, EmpireListe* empireListe, Empire* joueur, SystemeStellaire* systemeStellaires, Camera* camera, Fenetre* fenetre);
...
static void MenuSystemeFlotteDetails(char *key, SystemeStellaire *systemeStellaires, EmpireListe *empireListe, Empire* joueur, Camera *camera, Fenetre *fenetre);
...
static void MenuMarche(char *key, Empire* joueur, Marche *marche, Camera *camera, Fenetre *fenetre);

static void MenuListeFLottes(char *key, Empire *joueur, Camera *camera, Fenetre *fenetre);
